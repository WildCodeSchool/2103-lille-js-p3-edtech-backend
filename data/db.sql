...
/*!40101 SET @sa-- MySQL dump 10.13  Distrib 8.0.25, for Linux (x86_64)
--
-- Host: 127.0.0.1    Database: edtech
-- ------------------------------------------------------
-- Server version	8.0.25-0ubuntu0.20.04.1
...
--
-- Table structure for table `actus_img`
--

DROP TABLE IF EXISTS `actus_img`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `actus_img` (
...
--
-- Dumping data for table `actus_img`
--

LOCK TABLES `actus_img` WRITE;
/*!40000 ALTER TABLE `actus_img` DISABLE KEYS */;
INSERT INTO `actus_img` VALUES (1,'photo_actu1','http://greenscreenlab.com/wp-content/uploads/2017/03/Free-Stock-Photography-Website-Pixabay1.jpg','actu1','https://www.voyageway.com/visiter-lille'),(2,'photo_actu2','https://www.voyageway.com/wp-content/uploads/2020/05/visiter-lille-740x459.jpg','actu2','https://www.voyageway.com/visiter-lille'),(3,'photo_actu3','https://www.voyageway.com/wp-content/uploads/2020/05/visiter-lille-740x459.jpg','actu3','https://www.voyageway.com/visiter-lille');
/*!40000 ALTER TABLE `actus_img` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `actus_text`
--

DROP TABLE IF EXISTS `actus_text`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `actus_text` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tagname` varchar(45) NOT NULL,
  `fr` varchar(455) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `actus_text`
--

LOCK TABLES `actus_text` WRITE;
/*!40000 ALTER TABLE `actus_text` DISABLE KEYS */;
INSERT INTO `actus_text` VALUES (1,'actu1','lien vers l\'actu 1'),(2,'actu2','lien vers l\'actu 2'),(3,'actu3','lien vers l\'actu 3'),(4,'actu4','lien vers l\'actu 4'),(5,'actu5','lien vers l\'actu 5'),(6,'content_actu1','Lorem, ipsum dolor sit amet consectetur...'),(7,'content_actu2','Lorem, ipsum dolor sit amet consectetur...'),(8,'content_actu3','Lorem, ipsum dolor sit amet consectetur...'),(9,'content_actu4','Lorem, ipsum dolor sit amet consectetur...'),(10,'content_actu5','Lorem, ipsum dolor sit amet consectetur...'),(11,'title_actu1','Lorem, ipsum '),(12,'title_actu2','Lorem, ipsum '),(13,'title_actu3','Lorem, ipsum'),(14,'title_actu4','Lorem_ipsum'),(15,'title_actu5','Lorem, ipsum'),(16,'section_title','Actualités');
/*!40000 ALTER TABLE `actus_text` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `external_links` VALUES (1,'link_helloasso','https://www.helloasso.com/associations/edtech-hauts-de-france'),(2,'link_newsletter','http://eepurl.com/hhJSqj'),(3,'link_facebook','https://www.facebook.com/Edtech.HdF'),(4,'link_linkedIn','https://www.linkedin.com/company/edtech-hauts-de-france/'),(5,'link_twitter','https://twitter.com/edtech_hdf'),(6,'link_map','https://livemap.getwemap.com/embed.html?emmid=15883&iframeid=ed23008b-869a-482f-8f70-21c1041b88ed&parentLocation=https%3A%2F%2Flivemap.getwemap.com%2Fembed.html&parentOrigin=https%3A%2F%2Flivemap.getwemap.com&token=CQW96JV4PEI60Z56A7MBB7G2X#/search@48.8526893,2.3282879,5.00'),(7,'link_actu1','https://www.lemonde.fr/idees/article/2021/06/21/bac-2021-nous-professeurs-de-philosophie-nous-nous-abstiendrons-de-participer-a-la-mascarade-de-cette-edition_6085063_3232.html'),(8,'link_actu2','https://www.lemonde.fr/idees/article/2021/06/21/bac-2021-nous-professeurs-de-philosophie-nous-nous-abstiendrons-de-participer-a-la-mascarade-de-cette-edition_6085063_3232.html'),(9,'link_actu3','https://www.lemonde.fr/idees/article/2021/06/21/bac-2021-nous-professeurs-de-philosophie-nous-nous-abstiendrons-de-participer-a-la-mascarade-de-cette-edition_6085063_3232.html');
...
-- Dump completed on 2021-07-01 10:28:11ved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `actus` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` varchar(64) NOT NULL,
